...
namespace Microsoft.CodeFinder.Extensions
{
    /// <summary>
    ...
    public static class StringExtensions
    {
        ...
        /// <param name="inclusive">Optional, defaults to true. If false, <paramref name="startCharacter"/> and <paramref name="endCharacter"/> will not be removed.
        /// <returns></returns>
