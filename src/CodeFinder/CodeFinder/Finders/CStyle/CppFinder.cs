...
namespace Microsoft.CodeFinder.Finders.CStyle
{
    ...
    {
        public CppFinder(string fileContents) : base(fileContents)
        {
        ...
        private static List<string> SanitizeFunctionSignature(string functionSignature)
        {
            ...
            // E.g. _ToastController::TryStartLifetimeManagerIfNecessary_::_1_::catch$1 -> ToastController::TryStartLifetimeManagerIfNecessary
            ...
            // E.g.: SubController::RegisterSinkGeneric_MuxController::SinkData,INotificationControllerDataSink_ -> SubController::RegisterSinkGeneric
            ...
            // See https://dev.azure.com/microsoft/OS/_workitems/edit/24051839 for more details.
