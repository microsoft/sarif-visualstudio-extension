...
namespace Microsoft.Sarif.Viewer.ErrorList
{
    ...
    /// </remarks>
    internal class SarifTableDataSourceSink : IDisposable
    {
        ...
        /// <summary>
        /// Creates a new instance a disposable table data sink to return back to Visual Studio.
        /// </summary>
        /// <param name="sink">
        /// The Visual Studio table data sink that will receive notifications about SARIF error entries.
        /// </param>
        public SarifTableDataSourceSink(ITableDataSink sink)
        {
